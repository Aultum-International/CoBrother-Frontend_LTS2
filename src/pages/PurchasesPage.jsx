    ...
    <AppLayout>
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatCard label={t('purchases.domains', 'Domains')}          value={completedDomains.length}     iconSrc={DomainsIcon} color="#6eadc8" />
          <StatCard label={t('purchases.software', 'Software')}         value={completedSoftware.length}    iconSrc={SoftwareIcon} color="#a06ec8" />
          <StatCard label={t('purchases.coBrotherActive', 'CoBrother Active')}
