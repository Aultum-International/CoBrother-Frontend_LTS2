...
export const communityAPI = {
  ...
  update: (id, data) =>
    api.put(`/api/v1/community/${id}`, data),

  linkedInAuthUrl: () =>
    api.get('/api/v1/community/linkedin/auth'),

  linkedInCallback: (code) =>
    api.get(`/api/v1/community/linkedin/callback?code=${code}`),

  // ✅ ADD THIS LINE
  deleteCommunity: (id) =>
    api.delete(`/api/v1/community/${id}`),
};
