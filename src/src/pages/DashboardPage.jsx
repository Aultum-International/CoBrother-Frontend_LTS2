...
const quickStats = [
  { label: t('nav.ventures', 'Ventures'), value: quickCounts.ventures },
  { label: t('nav.disruptor', 'Disruptors'), value: quickCounts.disruptors },
  { label: t('nav.domains', 'Domains'), value: quickCounts.domains },
  { label: t('nav.technology', 'Technology'), value: quickCounts.technology },
];
