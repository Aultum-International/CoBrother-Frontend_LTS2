        ...
        <div className="flex justify-between w-full">
          ...
          <div className="flex items-end gap-3 flex-wrap">
            ...
            >
              ...
              />
              {t('venturesPage.dashboard')}
            </button>

            <button
              className="inline-flex items-center rounded-xl border border-white/70 bg-white/90 px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
            ...
            <Link
              to="/ventures/new"
              className="inline-flex items-center rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_10px_24px_rgba(99,102,241,0.35)] transition-all hover:-translate-y-0.5 hover:shadow-[0_14px_28px_rgba(99,102,241,0.42)]"
            >
              {t('venturesPage.listVenture')}
            </Link>
