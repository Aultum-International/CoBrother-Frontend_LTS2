    ...
    <AppLayout>
      <div className="max-w-[1100px]flex flex-col">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="font-display text-3xl font-bold text-gray-900 m-0">Venture Analytics</h1>
            <p className="text-gray-600 mt-1">Track performance and applicant insights for your ventures.</p>
          </div>
