    ...
    <div className="flex justify-between w-full">
      ...
      <div className="flex flex-col">
        ...
        <div className="inline-flex w-fit gap-2 rounded-2xl border border-white/70 bg-white/80 p-1.5 mt-4">
          ...
          >
            {t('technologyPage.allTechnology')}
          </button>
      ...
      <div className="flex items-end gap-3 flex-wrap">
        ...
        <button
          ...
          onClick={() => navigate('/cocreation/dashboard')}
        >
          <LayoutDashboard size={16} />
          {t('technologyPage.dashboard')}
        </button>
        ...
        {user && (
          ...
          >
            <Plus size={16} />
            {t('technologyPage.listTechnology')}
          </button>
        )}
